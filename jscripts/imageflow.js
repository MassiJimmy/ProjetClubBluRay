...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		slideshowSpeed:     1000,           /* Time between slides in ms */
	...
	this.refresh = function()
	{
		...
		my.navigationDiv.style.height = '80px';
		/* overriden by Gilles */

		/* Change captions div properties */
		my.captionDiv.style.width = my.imagesDivWidth * 0.90 + 'px';
		my.captionDiv.style.paddingTop = Math.round(my.imagesDivWidth * 0.01) + 'px';

		/* Change scrollbar div properties */
		my.scrollbarDiv.style.width = my.scrollbarWidth + 'px';
		my.scrollbarDiv.style.marginTop = Math.round(my.imagesDivWidth * 0.01) + 'px';
